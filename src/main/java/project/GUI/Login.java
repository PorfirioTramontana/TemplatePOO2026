...
public class Login extends JFrame {
	...
	private void initialize() {
		...
		ImageIcon logo = new ImageIcon(this.getClass().getResource("/project/images/logoPrincipale.png"));
		...
		ImageIcon imgAccopuIcon = new ImageIcon(this.getClass().getResource("/project/images/iconaAccount4.png"));
		...
		ImageIcon IconLogin= new ImageIcon(this.getClass().getResource("/project/images/SchermataLogin.png"));
		...
		ImageIcon imgAccopuIcon2 = new ImageIcon(this.getClass().getResource("/project/images/ImagePrincipal2.png"));
		...
		ImageIcon IcocinaAccount= new ImageIcon(this.getClass().getResource("/project/images/AccountIcona2.png"));
		...
		ImageIcon IcocinaLuchetto= new ImageIcon(this.getClass().getResource("/project/images/lucchettoIcocina.png"));
