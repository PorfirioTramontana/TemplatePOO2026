...
public class FormCollegamentoEsami extends JPanel
{
	...
	public FormCollegamentoEsami(Controller c,JFrame framecorrente) 
	{
		...
		ImageIcon imgiconaIcon1 = new ImageIcon(this.getClass().getResource("/project/images/EsameIconaEVO11.png"));
		ImageIcon imgiconaIcon2 = new ImageIcon(this.getClass().getResource("/project/images/EsameIconaEVO21.png"));
		ImageIcon imgiconaIcon3 = new ImageIcon(this.getClass().getResource("/project/images/EsameIconaEVO3.png"));
		if(n==0)
		{
