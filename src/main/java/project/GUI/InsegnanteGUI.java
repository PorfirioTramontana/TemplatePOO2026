...
public class InsegnanteGUI extends JFrame {
	...
	public InsegnanteGUI(Controller c,JFrame frameChiamante,String email) 
	{
		...
		ImageIcon imgAccopuIcon = new ImageIcon(this.getClass().getResource("/project/images/iconaBack2.png"));
		...
		ImageIcon imgAccopuIcon3 = new ImageIcon(this.getClass().getResource("/project/images/iconaAccount6.png"));
		...
		ImageIcon imgNuovoquiz= new ImageIcon(this.getClass().getResource("/project/images/plusicon.png"));
