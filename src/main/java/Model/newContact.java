...
public class newContact {
    ...
    public newContact(String first_name, String last_name, String email, String mobile, String landline, String street, Integer cap, String city, String country) {
        this.idContact = null;
    ...
    public Contact newContactToContact(newContact contact){
